...
$j(document).ready(function () {
    ...
    //     enquire.register('screen and (max-width: 1000px)', {
    //         match: function () {
    //             var leftColumn = $j('.col-left:not(.col-left-first)');
    //             var mainColLeft = $j('.main-col-left .col-left');
    //             leftColumn.css({"background" : "#f00"})

    //             leftColumn.appendTo(mainColLeft);
    //         },
    //         unmatch: function () {
    //             var leftColumn = $j('.col-left:not(.col-left-first)');
    //             var secColLeft = $j('.second-col-left');

    //             leftColumn.appendTo(secColLeft);
    //         }
    //     });
    // }
